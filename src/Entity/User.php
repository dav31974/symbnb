 ...
 * @UniqueEntity(
 * fields={"email"},
 * message="Un autre utilisateur s'est deja incrit avec cette adresse email, merci de la modifier"
 * )
 * 
 */
class User implements UserInterface
{
     ...
     * @Assert\Url(message="Veuillez donner une URL valide de votre avatar !")
     */
    private $picture;
