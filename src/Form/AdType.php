    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('slug', TextType::class, $this->getConfiguration(
                "Adresse web", "Tapez l'adress web (automatique)",
                 [
                     'required' => false
                     ]))
            ...
            ->add('content', TextareaType::class, $this->getConfiguration("Description détaillé", "Tapez une description qui donne vraiment envie de vennir chez vous !"))
            ...
            ->add('rooms', IntegerType::class, $this->getConfiguration("Nombre de chambres", "Le nombres de chambres disponnibles"))
            ->add(
                'images',
